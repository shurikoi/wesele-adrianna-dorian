...
export default function BackArrowIcon({ className = "", onClick }: BackArrowIconProps) {
    return (
        <div className={`absolute left-0 top-0 m-[1.9rem] p-[2px] cursor-pointer ${className}`} onClick={onClick}>
            <svg
                width="24"
                height="24"
                viewBox="0 0 24 24"
