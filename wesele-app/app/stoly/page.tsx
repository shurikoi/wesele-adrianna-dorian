                    ...
                    <div className="w-[300px] h-[50px] relative cursor-pointer">
                        <Table>
                            <div className="flex w-full h-full absolute top-[-10] gap-2 justify-center pl-3">
                                ...
                                <Chair className="mx-2" classNameLabel="top-4 -right-1"  chairData={tables.find(chair => chair.tableNumber === 0 && chair.chair === 4)} />
                                <Chair className="mx-2" classNameLabel="top-4 -right-10"  chairData={tables.find(chair => chair.tableNumber === 0 && chair.chair === 5)} />
                            </div>
                        </Table>
                    </div>
